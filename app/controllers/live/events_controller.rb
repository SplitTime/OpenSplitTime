module Live
  class EventsController < Live::BaseController
    ...
    def aid_station_detail
      ...
      @aid_station_detail =
        AidStationDetail.new(event: event, parameterized_split_name: parameterized_split_name, params: prepared_params)
    end
    ...
    def reset_stale_effort_data
      Interactors::ResetEffortPerformanceData.perform!(@event)
    end
  end
end
