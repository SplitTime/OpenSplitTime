module EventGroupsHelper
  def button_to_event_group_disable_live(view_object)
    button_to "Disable Live Entry",
              organization_event_group_path(view_object.organization, view_object.event_group,
                                            event_group: { available_live: false }),
              method: :patch,
              data: { turbo_confirm: t("event_groups.setup.disable_live_confirm",
  ...
  def button_to_event_group_enable_live(view_object)
    button_to "Enable Live Entry",
              organization_event_group_path(view_object.organization, view_object.event_group,
                                            event_group: { available_live: true }),
              method: :patch,
              data: { turbo_confirm: t("event_groups.setup.enable_live_confirm",
                                       event_group_name: view_object.event_group_name) },
              class: "btn btn-outline-success"
  end
  ...
  def button_to_event_group_make_public(view_object)
    button_to "Go Public",
              organization_event_group_path(view_object.organization, view_object.event_group,
                                            event_group: { concealed: false }),
              method: :patch,
              data: { turbo_confirm: t("event_groups.setup.make_public_confirm",
                                       event_group_name: view_object.event_group_name) },
              class: "btn btn-outline-success"
  end
