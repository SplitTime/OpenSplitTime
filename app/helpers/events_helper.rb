...
module EventsHelper
  ...
  def link_to_toggle_live_entry(view_object)
    if view_object.available_live?
      ...
      confirm_text = "NOTE: This will suspend all live entry actions for #{view_object.event_group_name}, " +
      ...
      confirm_text = "NOTE: This will enable live entry actions for #{view_object.event_group_name}, " +
  ...
  def link_to_toggle_public_private(view_object)
    if view_object.concealed?
      ...
      confirm_text = "NOTE: This will make #{view_object.event_group_name} visible to the public, " +
          'including all related efforts and people. Are you sure you want to proceed?'
    else
      button_text = 'Make private'
      confirm_text = "NOTE: This will conceal #{view_object.event_group_name} from the public, " +
