    ...
    def self.all
      {ramble:
       ...
       overall_30s_40s_50s_seniors:
           Results::Template.new('Overall, 30s, 40s, 50s, Seniors', :inclusive, 3,
                                 [:men_overall, :women_overall, :men_under_30, :women_under_30,
                                  :men_30s, :women_30s, :men_40s, :women_40s,
       ...
       masters_and_grandmasters:
           Results::Template.new('Masters and Grandmasters', :inclusive, 3,
