...
Effort.create(event_id: 3, participant_id: 4, wave: nil, bib_number: 99, city: 'Vancouver', state_code: 'BC', country_code: 'CA', age: 50, start_time: "2012-08-08 05:00:00", finished: true, first_name: 'Jen', last_name: 'Huckster', gender: 'female')
Effort.create(event_id: 3, participant_id: 1, wave: nil, bib_number: 12, city: 'Boulder', state_code: 'CO', country_code: 'US', age: 23, start_time: "2012-08-08 05:00:00", finished: true, first_name: 'Joe', last_name: 'Hardman', gender: 'male')
Effort.create(event_id: 1, participant_id: 2, wave: nil, bib_number: 1775, city: 'Atlanta', state_code: 'GA', country_code: 'US', age: 24, start_time: "2010-08-10 06:00:00", finished: true, first_name: 'Jane', last_name: 'Rockstar', gender: 'female')
Effort.create(event_id: 2, participant_id: 3, wave: nil, bib_number: 44, city: 'Guildford', state_code: 'SRY', country_code: 'GB', age: 20, start_time: "2015-05-31 07:00:00", finished: false, first_name: 'Basil', last_name: 'Smith', gender: 'male')
Effort.create(event_id: 1, participant_id: 3, wave: nil, bib_number: 66, city: 'Cranleigh', state_code: 'SRY', country_code: 'GB', age: 15, start_time: "2010-08-10 06:00:00", finished: true, first_name: 'Basil', last_name: 'Smith', gender: 'male')
Effort.create(event_id: 3, participant_id: 2, wave: nil, bib_number: 150, city: 'Nantucket', state_code: 'MA', country_code: 'US', age: 26, start_time: "2012-08-08 05:00:00", finished: true, first_name: 'Jane', last_name: 'Rockstar', gender: 'female')
