...
Event.create(course_id: 2, race_id: 3, name: 'Hardly Rocker 2010', start_time: "2010-08-10 06:00:00", laps_required: 1)
Event.create(course_id: 2, race_id: 2, name: 'Frozen Lips 2015', start_time: "2015-05-31 07:00:00", laps_required: 1)
Event.create(course_id: 1, race_id: nil, name: 'Test Event', start_time: "2012-08-08 05:00:00", laps_required: 1)
Event.create(course_id: 4, race_id: 4, name: 'Hardrock 100 2015', start_time: "2015-07-10 06:00:00", laps_required: 1)
...
Connection.create(user_id: 2, participant_id: 1, kind: :active)
Connection.create(user_id: 2, participant_id: 3, kind: :casual)
Connection.create(user_id: 2, participant_id: 4, kind: :casual)
Connection.create(user_id: 3, participant_id: 1, kind: :pending_active)
Connection.create(user_id: 3, participant_id: 2, kind: 0)
Connection.create(user_id: 4, participant_id: 2, kind: 1)
Connection.create(user_id: 4, participant_id: 3, kind: 0)
Connection.create(user_id: 4, participant_id: 4, kind: 2)
