...
SplitTime.create!(effort: jen_test, split: test_start, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 0)
SplitTime.create!(effort: jen_test, split: test_aid_1, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 4000)
SplitTime.create!(effort: jen_test, split: test_aid_2, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 4100)
SplitTime.create!(effort: jen_test, split: test_finish, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 8000)
SplitTime.create!(effort: joe_test, split: test_start, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 0)
SplitTime.create!(effort: joe_test, split: test_aid_1, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 5000)
SplitTime.create!(effort: joe_test, split: test_aid_2, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 5100)
SplitTime.create!(effort: joe_test, split: test_finish, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 9000)
SplitTime.create!(effort: jane_test, split: test_start, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 0)
SplitTime.create!(effort: jane_test, split: test_aid_1, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 3000)
SplitTime.create!(effort: jane_test, split: test_aid_2, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 3100)
SplitTime.create!(effort: jane_test, split: test_finish, lap: 1, bitkey: 1, absolute_time: test_event.start_time + 7500)
