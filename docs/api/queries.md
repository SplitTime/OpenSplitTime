...
$ curl -H "Authorization: bearer your.api.key" \
  https://www.opensplittime.org/api/v1/event_groups
```
...
```bash
$ curl -H "Authorization: bearer your.api.key" \
  https://www.opensplittime.org/api/v1/event_groups/hardrock-100-2024/raw_times
```
...
```bash
$ curl -H "Authorization: bearer your.api.key" \
  https://www.opensplittime.org/api/v1/events/5
```
...
```bash
$ curl -H "Authorization: bearer your.api.key" \
  https://www.opensplittime.org/api/v1/events/5/spread
```
...
| `entered_time` | Yes | Must be a string in the format `"YYYY-MM-DD HH:MM:SS-6:00"`. The time zone offset must be included in the format `"+HH:MM"` or `"-HH:MM"`. |
