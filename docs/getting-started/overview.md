...
**Organization:** This is the basic administrative unit in OpenSplitTime, like [Hardrock 100](https://www.opensplittime.org/organizations/hardrock). Each Event Group, Event Series, and Course belongs to an Organization. This is the way you (as the Organization creator) can create and modify your own Events and invite trusted Stewards to help.

**Course:** The physical course on which your event is run, ridden, swum (swam?), flown, or climbed, like [Hardrock Clockwise](https://www.opensplittime.org/organizations/hardrock/courses/hardrock-100-clockwise).
...
**Event Group:** A group of events happening on or about the same time, like [2019 RUFA](https://www.opensplittime.org/event_groups/2019-running-up-for-air-slc). Some Event Groups will have just one Event, like a 100 miler that has no shorter course alternative. Others will have multiple Events, like a 30K, 50K, and 100K that are run on the same day.

**Event:** A single running of a race, ride, stage, or other...you know, event. An example would be the [2019 RUFA (24 hours)](https://www.opensplittime.org/events/2019-rufa-slc-24-hour).

**Person:** A person who has competed in at least one Event, like [Kilian Jornet](https://www.opensplittime.org/people/kilian-jornet).

**Entrant:** A Person in a single Event, like [Kilian at Hardrock 2016](https://www.opensplittime.org/efforts/hardrock-100-2016-kilian-jornet).
...
Raw Times are created using the Live Entry screen in opensplittime.org, or via [OST Remote](../ost-remote/), the easy-to-use iOS client app for live time recording, or by posting time data to the OpenSplitTime API.
