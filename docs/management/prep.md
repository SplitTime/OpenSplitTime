...
Each Event Group is either "available live" or not "available live." When an Event Group is available live, it is ready to accept Raw Times entered from the Live Entry screen (**Live > Time Entry**) or from [OST Remote](../ost-remote/).
...
If you plan to record times using [OST Remote](../ost-remote/), you will need to gather enough iOS devices (iPhones and iPads) for use at the various stations that will be recording times. When determining the number of devices you need, **remember to account for any stations that will need two devices**, for example, if you will be recording times both in and out of the station and the course is arranged such that participants check into and out of the station at different physical locations.
...
- [Swappa](https://swappa.com/buy/apple/ipad)
- [Gazelle](https://buy.gazelle.com/collections/ipads)
- [eBay](https://www.ebay.com/sch/i.html?_nkw=ipad+mini)
