  ...
  module Transformers
    module Async
      class HiloHistoricalFactsStrategy < Etl::Transformers::BaseTransformer
        PRIOR_OUTCOME_YEARS = (2017..2024).to_a.map { |year| :"Result_#{year}" }.freeze
        PRIOR_APPLICATION_YEARS = (2020..2024).to_a.map { |year| :"App_#{year}" }.freeze
        PRIOR_RESET_YEARS = (2020..2024).to_a.map { |year| :"Reset_#{year}" }.freeze
        ...
        def record_current_year_application(struct)
          ...
          return unless value.downcase == "yes"
        ...
        def record_volunteer_points(struct)
          ...
          return unless hours.present? && hours.positive?
