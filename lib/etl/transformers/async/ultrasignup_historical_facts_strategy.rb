    ...
    module Async
      class UltrasignupHistoricalFactsStrategy < Etl::Transformers::BaseTransformer
        ...
        def record_volunteer_reported(struct)
          ...
          return unless years_count.present? && years_count.positive?
        ...
        def record_current_qualifier(struct)
          ...
          return if reported_qualifier.blank?
        ...
        def record_emergency_contact(struct)
          ...
          return unless emergency_contact.present? || emergency_phone.present?
        ...
        def record_dns_since_finish(struct)
          ...
          return unless reported_dns_since_finish.present? && reported_dns_since_finish.to_s.numeric?
