module ProjectionAssessments
  class Runner
    ...
    def assess_effort
      ...
      current_completed_split_time = current_effort.split_times.find_by(
        lap: completed_lap,
        split_id: completed_split_id,
        bitkey: completed_bitkey
      )
      return unless current_completed_split_time

      completed_absolute_time = current_completed_split_time.absolute_time
      current_projected_split_time = current_effort.split_times.find_by(
        lap: projected_lap,
        split_id: projected_split_id,
        bitkey: projected_bitkey
      )
