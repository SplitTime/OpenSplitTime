...
RSpec.describe Etl::Transformers::AdilasBearStrategy do
  ...
  let(:event) { build_stubbed(:event, course: course, scheduled_start_time_local: "9/23/2016 6:00:00", event_group: event_group) }
  ...
  let(:logan) { build_stubbed(:split, course: course, base_name: "Logan", sub_split_bitmap: 65, distance_from_start: 17_220) }
  let(:leatham) { build_stubbed(:split, course: course, base_name: "Leatham", sub_split_bitmap: 65, distance_from_start: 31_704) }
  let(:richards) { build_stubbed(:split, course: course, base_name: "Richards", sub_split_bitmap: 65, distance_from_start: 36_210) }
  let(:cowley) { build_stubbed(:split, course: course, base_name: "Cowley", sub_split_bitmap: 65, distance_from_start: 48_280) }
