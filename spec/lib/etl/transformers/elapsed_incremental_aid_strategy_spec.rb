...
RSpec.describe ETL::Transformers::ElapsedIncrementalAidStrategy do
  ...
  let(:dry_fork) { build_stubbed(:split, course: course, base_name: "Dry Fork Outbound", sub_split_bitmap: 65, distance_from_start: 17_220) }
  let(:foot_bridge) { build_stubbed(:split, course: course, base_name: "Foot Bridge Outbound", sub_split_bitmap: 65, distance_from_start: 31_704) }
  let(:jaws) { build_stubbed(:split, course: course, base_name: "Jaws", sub_split_bitmap: 65, distance_from_start: 36_210) }
  let(:finish) { build_stubbed(:split, course: course, base_name: "Finish", sub_split_bitmap: 1, distance_from_start: 50_000) }
