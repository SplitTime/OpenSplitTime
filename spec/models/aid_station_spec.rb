...
RSpec.describe AidStation, type: :model do
  ...
  it "should be valid with an event_id and a split_id" do
    event_split = AidStation.create!(event_id: @event.id, split_id: @split.id)
  ...
  it "should be invalid without an event_id" do
    event_split = AidStation.new(event_id: nil, split_id: @split.id)
  ...
  it "should be invalid without a split_id" do
    event_split = AidStation.new(event_id: @event.id, split_id: nil)
    expect(event_split).not_to be_valid
