...
RSpec.describe Effort, type: :model do
  ...
  describe 'expected_time_from_start' do
    before do
      ...
      SplitTime.create!(effort: @effort2, split: @split1, time_from_start: 0)
      SplitTime.create!(effort: @effort2, split: @split2, time_from_start: 6000)
      SplitTime.create!(effort: @effort2, split: @split3, time_from_start: 6200)
      ...
      SplitTime.create!(effort: @effort10, split: @split2, time_from_start: 4200)
      ...
      @segment2 = Segment.new(@split3, @split4)
      @segment3 = Segment.new(@split5, @split6)
      @segment4 = Segment.new(@split1, @split5)
