...
RSpec.describe Effort, type: :model do
  ...
  describe 'within_time_range' do
    before do
      ...
      @split3 = Split.create!(course: @course, location: @location2, base_name: 'Test Aid Station', distance_from_start: 6000, sub_split_mask: 65, vert_gain_from_start: 500, vert_loss_from_start: 0, kind: 2)
      ...
      SplitTime.create!(effort: @effort1, split: @split3, sub_split_key: SubSplit::IN_KEY, time_from_start: 4000)
      SplitTime.create!(effort: @effort1, split: @split3, sub_split_key: SubSplit::OUT_KEY, time_from_start: 4100)
      SplitTime.create!(effort: @effort1, split: @split4, sub_split_key: SubSplit::IN_KEY, time_from_start: 8000)
      SplitTime.create!(effort: @effort2, split: @split1, sub_split_key: SubSplit::IN_KEY, time_from_start: 0)
      SplitTime.create!(effort: @effort2, split: @split3, sub_split_key: SubSplit::IN_KEY, time_from_start: 5000)
      SplitTime.create!(effort: @effort2, split: @split3, sub_split_key: SubSplit::OUT_KEY, time_from_start: 5100)
      SplitTime.create!(effort: @effort2, split: @split4, sub_split_key: SubSplit::IN_KEY, time_from_start: 9000)
      SplitTime.create!(effort: @effort3, split: @split1, sub_split_key: SubSplit::IN_KEY, time_from_start: 0)
      SplitTime.create!(effort: @effort3, split: @split3, sub_split_key: SubSplit::IN_KEY, time_from_start: 3000)
      SplitTime.create!(effort: @effort3, split: @split3, sub_split_key: SubSplit::OUT_KEY, time_from_start: 3100)
      SplitTime.create!(effort: @effort3, split: @split4, sub_split_key: SubSplit::IN_KEY, time_from_start: 7500)
  ...
  describe 'expected_time_from_start' do
    before do
      ...
      SplitTime.create!(effort: @effort2, split: @split1, sub_split_key: SubSplit::IN_KEY, time_from_start: 0)
      SplitTime.create!(effort: @effort2, split: @split2, sub_split_key: SubSplit::IN_KEY, time_from_start: 6000)
      SplitTime.create!(effort: @effort2, split: @split2, sub_split_key: SubSplit::OUT_KEY, time_from_start: 6200)
    ...
    context 'sufficient historical data' do
      ...
      before do
        ...
        SplitTime.create!(effort: @effort10, split: @split2, sub_split_key: SubSplit::IN_KEY, time_from_start: 4200)
