...
RSpec.describe Effort, type: :model do
  ...
  describe 'within_time_range' do
    before do
      ...
      SplitTime.create!(effort: @effort1, split: @split3, sub_split: @sub_split1, time_from_start: 4000)
      SplitTime.create!(effort: @effort1, split: @split3, sub_split: @sub_split2, time_from_start: 4100)
      ...
      SplitTime.create!(effort: @effort2, split: @split3, sub_split: @sub_split1, time_from_start: 5000)
      SplitTime.create!(effort: @effort2, split: @split3, sub_split: @sub_split2, time_from_start: 5100)
      ...
      SplitTime.create!(effort: @effort3, split: @split3, sub_split: @sub_split1, time_from_start: 3000)
      SplitTime.create!(effort: @effort3, split: @split3, sub_split: @sub_split2, time_from_start: 3100)
      SplitTime.create!(effort: @effort3, split: @split4, sub_split: @sub_split1, time_from_start: 7500)
  ...
  describe 'expected_time_from_start' do
    before do
      ...
      SplitTime.create!(effort: @effort2, split: @split1, sub_split: @sub_split1, time_from_start: 0)
      SplitTime.create!(effort: @effort2, split: @split2, sub_split: @sub_split1, time_from_start: 6000)
      SplitTime.create!(effort: @effort2, split: @split2, sub_split: @sub_split2, time_from_start: 6200)
      ...
      SplitTime.create!(effort: @effort10, split: @split2, sub_split: @sub_split1, time_from_start: 4200)
