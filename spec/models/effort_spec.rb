...
RSpec.describe Effort, type: :model do
  ...
  describe 'within_time_range' do
    before do
      ...
      split3 = Split.create!(course: course, location: location2, base_name: 'Test Aid Station', distance_from_start: 6000, split_sub_mask: 65, vert_gain_from_start: 500, vert_loss_from_start: 0, kind: 2)
      ...
      SplitTime.create!(effort: effort1, split: split3, sub_split_id: 1, time_from_start: 4000)
      SplitTime.create!(effort: effort1, split: split3, sub_split_id: 64, time_from_start: 4100)
      ...
      SplitTime.create!(effort: effort2, split: split3, sub_split_id: 1, time_from_start: 5000)
      SplitTime.create!(effort: effort2, split: split3, sub_split_id: 64, time_from_start: 5100)
      ...
      SplitTime.create!(effort: effort3, split: split3, sub_split_id: 1, time_from_start: 3000)
      SplitTime.create!(effort: effort3, split: split3, sub_split_id: 64, time_from_start: 3100)
  ...
  describe 'expected_time_from_start' do
    before do
      ...
      SplitTime.create!(effort: @effort1, split: @split4, sub_split_id: 1, time_from_start: 15200)
      SplitTime.create!(effort: @effort1, split: @split4, sub_split_id: 64, time_from_start: 15100)

      SplitTime.create!(effort: @effort2, split: @split1, sub_split_id: 1, time_from_start: 0)
      SplitTime.create!(effort: @effort2, split: @split2, sub_split_id: 64, time_from_start: 6000)
      SplitTime.create!(effort: @effort2, split: @split2, sub_split_id: 64, time_from_start: 6200)

      SplitTime.create!(effort: @effort3, split: @split1, sub_split_id: 1, time_from_start: 0)
      SplitTime.create!(effort: @effort3, split: @split2, sub_split_id: 1, time_from_start: 5000)
      SplitTime.create!(effort: @effort3, split: @split2, sub_split_id: 64, time_from_start: 5000)
      SplitTime.create!(effort: @effort3, split: @split4, sub_split_id: 1, time_from_start: 12200)
      SplitTime.create!(effort: @effort3, split: @split4, sub_split_id: 64, time_from_start: 12300)
      SplitTime.create!(effort: @effort3, split: @split6, sub_split_id: 1, time_from_start: 18000)

      SplitTime.create!(effort: @effort4, split: @split1, sub_split_id: 1, time_from_start: 1000)
      SplitTime.create!(effort: @effort4, split: @split2, sub_split_id: 1, time_from_start: 4500)
      SplitTime.create!(effort: @effort4, split: @split2, sub_split_id: 64, time_from_start: 4400)
      SplitTime.create!(effort: @effort4, split: @split4, sub_split_id: 1, time_from_start: 11000)
      SplitTime.create!(effort: @effort4, split: @split4, sub_split_id: 64, time_from_start: 11000)
      SplitTime.create!(effort: @effort4, split: @split6, sub_split_id: 1, time_from_start: 17500)

      SplitTime.create!(effort: @effort5, split: @split1, sub_split_id: 1, time_from_start: 0)
      SplitTime.create!(effort: @effort5, split: @split2, sub_split_id: 1, time_from_start: 4600)
      SplitTime.create!(effort: @effort5, split: @split2, sub_split_id: 64, time_from_start: 4800)
      SplitTime.create!(effort: @effort5, split: @split4, sub_split_id: 1, time_from_start: 9800)
      SplitTime.create!(effort: @effort5, split: @split4, sub_split_id: 64, time_from_start: 10000)
      SplitTime.create!(effort: @effort5, split: @split6, sub_split_id: 1, time_from_start: 14550)

      SplitTime.create!(effort: @effort6, split: @split1, sub_split_id: 1, time_from_start: 0)
      SplitTime.create!(effort: @effort6, split: @split4, sub_split_id: 1, time_from_start: 9600)
      SplitTime.create!(effort: @effort6, split: @split4, sub_split_id: 64, time_from_start: 9660)
      SplitTime.create!(effort: @effort6, split: @split6, sub_split_id: 1, time_from_start: 14650)

      SplitTime.create!(effort: @effort7, split: @split1, sub_split_id: 1, time_from_start: 0)
      SplitTime.create!(effort: @effort7, split: @split2, sub_split_id: 1, time_from_start: 6300)
      SplitTime.create!(effort: @effort7, split: @split2, sub_split_id: 64, time_from_start: 6600)
      SplitTime.create!(effort: @effort7, split: @split4, sub_split_id: 1, time_from_start: 13000)
      SplitTime.create!(effort: @effort7, split: @split4, sub_split_id: 64, time_from_start: 13500)

      SplitTime.create!(effort: @effort8, split: @split1, sub_split_id: 1, time_from_start: 0)
      SplitTime.create!(effort: @effort8, split: @split2, sub_split_id: 1, time_from_start: 5500)
      SplitTime.create!(effort: @effort8, split: @split2, sub_split_id: 64, time_from_start: 5500)
      SplitTime.create!(effort: @effort8, split: @split6, sub_split_id: 1, time_from_start: 18700)

      SplitTime.create!(effort: @effort9, split: @split1, sub_split_id: 1, time_from_start: 0)
      SplitTime.create!(effort: @effort9, split: @split2, sub_split_id: 1, time_from_start: 11000)
      SplitTime.create!(effort: @effort9, split: @split2, sub_split_id: 64, time_from_start: 12000)

      SplitTime.create!(effort: @effort10, split: @split1, sub_split_id: 1, time_from_start: 0)
      SplitTime.create!(effort: @effort10, split: @split2, sub_split_id: 1, time_from_start: 4200)
      SplitTime.create!(effort: @effort10, split: @split2, sub_split_id: 64, time_from_start: 4300)
      SplitTime.create!(effort: @effort10, split: @split4, sub_split_id: 1, time_from_start: 11000)
      SplitTime.create!(effort: @effort10, split: @split4, sub_split_id: 64, time_from_start: 11100)
      SplitTime.create!(effort: @effort10, split: @split6, sub_split_id: 1, time_from_start: 17600)

      SplitTime.create!(effort: @effort11, split: @split1, sub_split_id: 1, time_from_start: 0)
      SplitTime.create!(effort: @effort11, split: @split2, sub_split_id: 1, time_from_start: 6800)
      SplitTime.create!(effort: @effort11, split: @split2, sub_split_id: 64, time_from_start: 6800)

      SplitTime.create!(effort: @effort12, split: @split1, sub_split_id: 1, time_from_start: 0)
      SplitTime.create!(effort: @effort12, split: @split2, sub_split_id: 1, time_from_start: 5300)
      SplitTime.create!(effort: @effort12, split: @split2, sub_split_id: 64, time_from_start: 5400)
      SplitTime.create!(effort: @effort12, split: @split4, sub_split_id: 1, time_from_start: 12500)
      SplitTime.create!(effort: @effort12, split: @split4, sub_split_id: 64, time_from_start: 12550)

      SplitTime.create!(effort: @effort13, split: @split1, sub_split_id: 1, time_from_start: 0)
      SplitTime.create!(effort: @effort13, split: @split2, sub_split_id: 1, time_from_start: 4900)
      SplitTime.create!(effort: @effort13, split: @split2, sub_split_id: 64, time_from_start: 4940)
      SplitTime.create!(effort: @effort13, split: @split4, sub_split_id: 1, time_from_start: 13400)
      SplitTime.create!(effort: @effort13, split: @split4, sub_split_id: 64, time_from_start: 14300)
      SplitTime.create!(effort: @effort13, split: @split6, sub_split_id: 1, time_from_start: 19800)

      @segment1 = Segment.new(@split1, @split2)
      @segment2 = Segment.new(@split2, @split4)
      @segment3 = Segment.new(@split4, @split6)
    ...
    context 'sufficient historical data' do
      ...
      it 'should determine expected time based on prior split_time and mean segment time (normalized to effort)' do
        expect(@effort1.expected_time_from_start(@split2)).to eq(0 + @calcs1.mean)
        expect(@effort2.expected_time_from_start(@split4)).to eq(6200 + ((6200/@calcs1.mean) * @calcs2.mean))
