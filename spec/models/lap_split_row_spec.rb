...
RSpec.describe LapSplitRow, type: :model do
  ...
  let(:split_3) { Split.new(course: course, base_name: "Aid Station 2", distance_from_start: 15_000, sub_split_bitmap: 73, vert_gain_from_start: 500, vert_loss_from_start: 0, kind: 2) }
  let(:split_4) { Split.new(course: course, base_name: "Finish Line", distance_from_start: 25_000, sub_split_bitmap: 1, vert_gain_from_start: 700, vert_loss_from_start: 700, kind: 1) }
  ...
  let(:split_time_data_1) do
    SplitTimeData.new(effort_id: effort.id, lap: 1, split_id: split_1.id, bitkey: in_bitkey, time_from_start: tfs_1, segment_time: nil,
  ...
  let(:split_time_data_2) do
    SplitTimeData.new(effort_id: effort.id, lap: 1, split_id: split_2.id, bitkey: in_bitkey, time_from_start: tfs_2, segment_time: tfs_2 - tfs_1,
                      absolute_time_string: (event_start_time + tfs_2).to_s, absolute_time_local_string: (event.scheduled_start_time_local + tfs_2).to_s,
                      data_status_numeric: 2)
  end
  let(:split_time_data_3) do
    SplitTimeData.new(effort_id: effort.id, lap: 1, split_id: split_2.id, bitkey: out_bitkey, time_from_start: tfs_3, segment_time: tfs_3 - tfs_2,
                      absolute_time_string: (event_start_time + tfs_3).to_s, absolute_time_local_string: (event.scheduled_start_time_local + tfs_3).to_s,
                      data_status_numeric: 2)
  end
  let(:split_time_data_4) do
    SplitTimeData.new(effort_id: effort.id, lap: 1, split_id: split_3.id, bitkey: in_bitkey, time_from_start: tfs_4, segment_time: tfs_4 - tfs_3,
                      absolute_time_string: (event_start_time + tfs_4).to_s, absolute_time_local_string: (event.scheduled_start_time_local + tfs_4).to_s,
                      data_status_numeric: 2)
  end
  let(:split_time_data_5) do
    SplitTimeData.new(effort_id: effort.id, lap: 1, split_id: split_3.id, bitkey: out_bitkey, time_from_start: tfs_5, segment_time: tfs_5 - tfs_4,
  ...
  let(:split_time_data_6) do
    SplitTimeData.new(effort_id: effort.id, lap: 1, split_id: split_4.id, bitkey: in_bitkey, time_from_start: tfs_6, segment_time: tfs_6 - tfs_5,
