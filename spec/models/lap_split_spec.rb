...
RSpec.describe LapSplit, type: :model do
  ...
  describe "#<=>" do
    ...
    let(:split_2) { build_stubbed(:split, distance_from_start: 20_000) }
    let(:split_3) { build_stubbed(:split, distance_from_start: 30_000) }
  ...
  describe "#vert_gain_from_start" do
    ...
    context "when split.vert_gain_from_start is nil" do
      let(:lap) { 3 }
      let(:split) { splits.second }
      before { split.update(vert_gain_from_start: nil) }
  ...
  describe "#vert_loss_from_start" do
    ...
    context "when split.vert_loss_from_start is nil" do
      let(:lap) { 3 }
      let(:split) { splits.second }
