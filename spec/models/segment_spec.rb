...
RSpec.describe Segment, type: :model do
  ...
  describe 'initialization' do
    before do
      ...
      @segment1 = Segment.new(@split1.sub_split_in, @split6.sub_split_in)
      @segment2 = Segment.new(@split2.sub_split_in, @split2.sub_split_out)
      @segment3 = Segment.new(@split2.sub_split_out, @split4.sub_split_in)
      @segment4 = Segment.new(@split4.sub_split_out, @split6.sub_split_in)
    ...
    it 'should equate itself with other segments using the same splits' do
      ...
      segment5 = Segment.new(@split1.sub_split_in, @split6.sub_split_in)
      segment6 = Segment.new(@split2.sub_split_out, @split4.sub_split_in)
