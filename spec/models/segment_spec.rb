...
RSpec.describe Segment, type: :model do
  ...
  describe 'effort_velocity' do
    before do
      ...
      SplitTime.create!(effort: @effort2, split: @split1, sub_split_key: SubSplit::IN_KEY, time_from_start: 0)
      SplitTime.create!(effort: @effort2, split: @split2, sub_split_key: SubSplit::IN_KEY, time_from_start: 5000)
      SplitTime.create!(effort: @effort2, split: @split2, sub_split_key: SubSplit::OUT_KEY, time_from_start: 5000)
      SplitTime.create!(effort: @effort2, split: @split4, sub_split_key: SubSplit::IN_KEY, time_from_start: 9000)
      SplitTime.create!(effort: @effort3, split: @split1, sub_split_key: SubSplit::IN_KEY, time_from_start: 0)
      SplitTime.create!(effort: @effort3, split: @split2, sub_split_key: SubSplit::IN_KEY, time_from_start: 6000)
      SplitTime.create!(effort: @effort3, split: @split2, sub_split_key: SubSplit::OUT_KEY, time_from_start: 9200)
      SplitTime.create!(effort: @effort3, split: @split4, sub_split_key: SubSplit::IN_KEY, time_from_start: 9000)
