...
RSpec.describe Segment, type: :model do
  ...
  let(:aid_1) { build_stubbed(:split, base_name: "Aid 1", course_id: 10, distance_from_start: 10_000, vert_gain_from_start: 1000, vert_loss_from_start: 500) }
  let(:aid_2) { build_stubbed(:split, base_name: "Aid 2", course_id: 10, distance_from_start: 25_000, vert_gain_from_start: 2500, vert_loss_from_start: 1250) }
  let(:aid_3) { build_stubbed(:split, base_name: "Aid 3", course_id: 10, distance_from_start: 45_000, vert_gain_from_start: 4500, vert_loss_from_start: 2250) }
  let(:finish) { build_stubbed(:split, :finish, course_id: 10, distance_from_start: 70_000, vert_gain_from_start: 7000, vert_loss_from_start: 3500) }
  let(:lap_1_start_to_lap_1_aid_1) do
    build(:segment, begin_lap: 1, begin_split: start, begin_in_out: "in",
                    end_lap: 1, end_split: aid_1, end_in_out: "in")
  end
  let(:lap_1_start_to_lap_1_aid_2) do
    build(:segment, begin_lap: 1, begin_split: start, begin_in_out: "in",
                    end_lap: 1, end_split: aid_2, end_in_out: "in")
  end
  let(:lap_1_start_to_lap_1_aid_3) do
    build(:segment, begin_lap: 1, begin_split: start, begin_in_out: "in",
                    end_lap: 1, end_split: aid_3, end_in_out: "in")
  end
  let(:lap_1_start_to_lap_1_finish) do
    build(:segment, begin_lap: 1, begin_split: start, begin_in_out: "in",
                    end_lap: 1, end_split: finish, end_in_out: "in")
  end
  let(:lap_1_aid_1_to_lap_1_aid_2) do
    build(:segment, begin_lap: 1, begin_split: aid_1, begin_in_out: "out",
                    end_lap: 1, end_split: aid_2, end_in_out: "in")
  end
  let(:lap_1_aid_2_to_lap_1_aid_3) do
    build(:segment, begin_lap: 1, begin_split: aid_2, begin_in_out: "out",
                    end_lap: 1, end_split: aid_3, end_in_out: "in")
  end
  let(:lap_1_aid_3_to_lap_1_finish) do
    build(:segment, begin_lap: 1, begin_split: aid_3, begin_in_out: "out",
                    end_lap: 1, end_split: finish, end_in_out: "in")
  end
  let(:lap_1_aid_1_to_lap_1_finish) do
    build(:segment, begin_lap: 1, begin_split: aid_1, begin_in_out: "out",
                    end_lap: 1, end_split: finish, end_in_out: "in")
  end
  let(:lap_1_aid_2_to_lap_1_finish) do
    build(:segment, begin_lap: 1, begin_split: aid_2, begin_in_out: "out",
                    end_lap: 1, end_split: finish, end_in_out: "in")
  end
  let(:lap_1_in_aid_1) do
    build(:segment, begin_lap: 1, begin_split: aid_1, begin_in_out: "in",
                    end_lap: 1, end_split: aid_1, end_in_out: "out")
  end
  let(:lap_1_in_aid_2) do
    build(:segment, begin_lap: 1, begin_split: aid_2, begin_in_out: "in",
                    end_lap: 1, end_split: aid_2, end_in_out: "out")
  end
  let(:lap_1_in_aid_3) do
    build(:segment, begin_lap: 1, begin_split: aid_3, begin_in_out: "in",
                    end_lap: 1, end_split: aid_3, end_in_out: "out")
  end
  let(:lap_1_aid_1_to_lap_1_aid_2_inclusive) do
    build(:segment, begin_lap: 1, begin_split: aid_1, begin_in_out: "in",
                    end_lap: 1, end_split: aid_2, end_in_out: "out")
  end
  let(:lap_1_zero_start) do
    build(:segment, begin_lap: 1, begin_split: start, begin_in_out: "in",
  ...
  let(:lap_2_zero_start) do
    build(:segment, begin_lap: 2, begin_split: start, begin_in_out: "in",
                    end_lap: 2, end_split: start, end_in_out: "in")
  end
  let(:lap_1_start_to_lap_2_aid_1) do
    build(:segment, begin_lap: 1, begin_split: start, begin_in_out: "in",
                    end_lap: 2, end_split: aid_1, end_in_out: "in")
  end
  let(:lap_1_start_to_lap_2_finish) do
    build(:segment, begin_lap: 1, begin_split: start, begin_in_out: "in",
                    end_lap: 2, end_split: finish, end_in_out: "in")
  end
  let(:lap_1_finish_to_lap_2_start) do
    build(:segment, begin_lap: 1, begin_split: finish, begin_in_out: "in",
                    end_lap: 2, end_split: start, end_in_out: "in")
  end
  ...
  describe "initialization" do
    ...
    it "raises an error when splits on the same lap are out of order" do
      ...
      end_in_out = "in"
      expect do
        build(:segment, begin_lap: begin_lap, begin_split: begin_split, begin_in_out: begin_in_out,
  ...
  describe "#distance" do
    ...
    it "calculates distance properly for single segments" do
      validate_attribute(:distance, lap_1_start_to_lap_1_aid_1, 10_000)
      validate_attribute(:distance, lap_1_aid_1_to_lap_1_aid_2, 15_000)
      validate_attribute(:distance, lap_1_aid_2_to_lap_1_aid_3, 20_000)
      validate_attribute(:distance, lap_1_aid_3_to_lap_1_finish, 25_000)
    end

    it "calculates distance properly for extended segments" do
      validate_attribute(:distance, lap_1_start_to_lap_1_aid_2, 25_000)
      validate_attribute(:distance, lap_1_start_to_lap_1_aid_3, 45_000)
      validate_attribute(:distance, lap_1_start_to_lap_1_finish, 70_000)
      validate_attribute(:distance, lap_1_aid_1_to_lap_1_finish, 60_000)
      validate_attribute(:distance, lap_1_aid_2_to_lap_1_finish, 45_000)
    end
    ...
    it "calculates distance properly for unusual segments" do
      validate_attribute(:distance, lap_1_aid_1_to_lap_1_aid_2_inclusive, 15_000)
    end

    it "calculates distance properly between laps for completed laps" do
      validate_attribute(:distance, lap_1_start_to_lap_2_finish, 140_000)
    end

    it "calculates distance properly between laps for partially completed laps" do
      validate_attribute(:distance, lap_1_start_to_lap_2_aid_1, 80_000)
    end
  end
  ...
  describe "#vert_gain" do
    ...
    it "calculates vert_gain properly between laps for completed laps" do
      validate_attribute(:vert_gain, lap_1_start_to_lap_2_finish, 14_000)
    end
