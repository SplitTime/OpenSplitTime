...
RSpec.describe SegmentTimes do
  ...
  describe '#low_bad, #low_questionable, #high_questionable, and #high_bad' do
    ...
    context 'when the number of times is at or above the STAT_CALC_THRESHOLD, between splits' do
      it 'returns an array of low_bad, low_questionable, high_questionable, and high_bad times based on stats' do
        times_hash1 = {101 => 10000, 102 => 7000, 103 => 15000, 104 => 20000, 105 => 21000,
                       106 => 30000, 107 => 31000, 108 => 40000, 109 => 41000, 110 => 50000}
        times_hash2 = {101 => 20000, 102 => 17000, 103 => 25000, 104 => 30000, 105 => 31000,
                       106 => 45000, 107 => 46000, 108 => 55000, 109 => 56000, 110 => 65000}
    ...
    context 'when the number of times is at or above the STAT_CALC_THRESHOLD, within a split' do
      it 'returns an specified low_bad, low_questionable, high_questionable, and high_bad times' do
        times_hash1 = {101 => 10000, 102 => 7000, 103 => 15000, 104 => 20000, 105 => 21000,
                       106 => 30000, 107 => 31000, 108 => 40000, 109 => 41000, 110 => 50000}
        times_hash2 = {101 => 20000, 102 => 17000, 103 => 25000, 104 => 30000, 105 => 31000,
                       106 => 45000, 107 => 46000, 108 => 55000, 109 => 56000, 110 => 65000}
        segment_calcs = SegmentTimes.new(segment2, times_hash1, times_hash2)
        expect(segment_calcs.low_bad).to eq(0)
        expect(segment_calcs.low_questionable).to eq(0)
        expect(segment_calcs.high_questionable).to eq(6.hours)
        expect(segment_calcs.high_bad).to eq(1.day)
      end
    end
  end
