...
RSpec.describe User, type: :model do
  ...
  describe 'interests' do
    it 'should allow a single interest with a participant' do
      user = User.create!(first_name: 'Alan', last_name: 'Turing', email: 'at@gmail.com', password: 'imahuman')
    ...
    it 'should allow two interests with participants' do
      user = User.create!(first_name: 'Alan', last_name: 'Turing', email: 'at@gmail.com', password: 'imahuman')
    ...
    it 'should allow multiple users to create interests with a participant' do
