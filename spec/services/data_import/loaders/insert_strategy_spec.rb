...
RSpec.describe DataImport::Loaders::InsertStrategy do
  ...
  describe '#load_records' do
    context 'when all provided records are valid and none previously exists' do
      subject { DataImport::Loaders::InsertStrategy.new(valid_proto_records, options) }
    ...
    context 'when any provided record is invalid' do
      subject { DataImport::Loaders::InsertStrategy.new(all_proto_records, options) }
    ...
    context 'when a parent record is valid but at least one child record is invalid' do
      subject { DataImport::Loaders::InsertStrategy.new(proto_with_invalid_child, options) }
