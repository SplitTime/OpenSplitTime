...
RSpec.describe Interactors::SetEffortStop do
  ...
  subject { described_class.new(effort, stop_status: stop_status, split_time_id: split_time_id) }

  let(:stop_status) { nil }
  let(:split_time_id) { nil }

  let(:split_time_1) { build_stubbed(:split_time, effort: effort, lap: 1, split: split_1, bitkey: in_bitkey, absolute_time: start_time, stopped_here: false) }
  let(:split_time_2) { build_stubbed(:split_time, effort: effort, lap: 1, split: split_2, bitkey: in_bitkey, absolute_time: start_time + 10_000, stopped_here: false) }
  let(:split_time_3) { build_stubbed(:split_time, effort: effort, lap: 1, split: split_2, bitkey: out_bitkey, absolute_time: start_time + 11_000, stopped_here: false) }
  let(:split_time_4) { build_stubbed(:split_time, effort: effort, lap: 1, split: split_3, bitkey: in_bitkey, absolute_time: start_time + 20_000, stopped_here: false) }
  let(:split_time_5) { build_stubbed(:split_time, effort: effort, lap: 1, split: split_3, bitkey: out_bitkey, absolute_time: start_time + 20_000, stopped_here: false) }
  let(:split_time_6) { build_stubbed(:split_time, effort: effort, lap: 1, split: split_4, bitkey: in_bitkey, absolute_time: start_time + 30_000, stopped_here: false) }
  let(:split_time_7) { build_stubbed(:split_time, effort: effort, lap: 2, split: split_1, bitkey: in_bitkey, absolute_time: start_time + 31_000, stopped_here: false) }
  ...
  describe "#perform" do
    ...
    context "when the final split_time has a stopped_here flag set to true" do
      let(:split_time_5) { build_stubbed(:split_time, effort: effort, lap: 1, split: split_3, bitkey: out_bitkey, absolute_time: start_time + 20_000, stopped_here: true) }
    ...
    context "when a split_time other than the final split_time has a stopped_here flag set to true" do
      let(:split_time_4) { build_stubbed(:split_time, effort: effort, lap: 1, split: split_3, bitkey: in_bitkey, absolute_time: start_time + 20_000, stopped_here: true) }
    ...
    context "when multiple split_times have a stopped_here flag set to true" do
      let(:split_time_3) { build_stubbed(:split_time, effort: effort, lap: 1, split: split_2, bitkey: out_bitkey, absolute_time: start_time + 11_000, stopped_here: true) }
      let(:split_time_4) { build_stubbed(:split_time, effort: effort, lap: 1, split: split_3, bitkey: in_bitkey, absolute_time: start_time + 20_000, stopped_here: true) }
      let(:split_time_5) { build_stubbed(:split_time, effort: effort, lap: 1, split: split_3, bitkey: out_bitkey, absolute_time: start_time + 20_000, stopped_here: true) }
    ...
    context "when the event is multi-lap and stop_status is true" do
